...
public class DuplicateLead {
	public static void main(String[] args) {
		...
		WebElement elementDupilcateLead = driver.findElement(By.linkText("Duplicate Lead"));
		elementDupilcateLead.click();
		
		WebElement elementClearAndCompanyName = driver.findElement(By.id("createLeadForm_companyName"));
		elementClearAndCompanyName.clear();
		elementClearAndCompanyName.sendKeys("CTS");
		
		WebElement elementClearAndFirstName = driver.findElement(By.id("createLeadForm_firstName"));
		elementClearAndFirstName.clear();
		elementClearAndFirstName.sendKeys("Anu");
